<?php
  ...
  $pd = $db->entrada($id);
	...
	for($i=0;$i<count($pedido);$i++){
		...
		echo "<td>";
		if($estado=="Activa"){
			echo "<button class='btn btn-outline-secondary btn-sm' id='eliminar_comision' data-lugar='a_entrada/db_' data-destino='a_entrada/form_pedido' data-id='".$pedido[$i]['llave']."' data-iddest='$id' data-funcion='borrar_producto' data-div='pedidos'><i class='far fa-trash-alt'></i></i></button>";
		}
		echo "</td>";
