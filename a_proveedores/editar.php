<?php 
	...
	if($id>0){
		...
		$numero = $bdd->numero("et_prove","id_prove");
		$pd = $bdd->cliente($id);
		$id=0;
		$razon="";
		$rfc="";
...
<div class="container">
	<div class='card'>
		<div class='card-body'>
			<form action="" id="form_cliente" data-lugar="a_proveedores/db_prove" data-funcion="guardar_proveedor">		
				<div class="header">
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<button class='btn btn-outline-secondary btn-sm' id='lista_penarea' data-lugar='a_proveedores/lista' title='regresar'><i class='fas fa-undo-alt'></i>Regresar</button>
						</div>
					</div>
				</div>
			</form>	
